$(document).ready(function()
{
    ...
    $(document).on('click', '.update-product-button', function()
    {
        ...
        $.getJSON("http://localhost/MICHAL-PHP/SimpleRestApiPhp/SERVER_API/product/read_one.php?id=" + id, function(data){
            ...
            $.getJSON("http://localhost/MICHAL-PHP/SimpleRestApiPhp/SERVER_API/category/read.php", function(data){
    ...
    $(document).on('submit', '#update-product-form', function()
    {
        ...
        $.ajax({
            url: "http://localhost/MICHAL-PHP/SimpleRestApiPhp/SERVER_API/product/update.php",
            type : "POST",
